...
template<> struct signature<jobject> { static constexpr auto value = to_array("Ljava/lang/Object;");};
template<> struct signature<jobjectArray> { static constexpr auto value = to_array("[Ljava/lang/Object;");};
